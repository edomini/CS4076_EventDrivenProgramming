...
import org.example.timetable.network.Lecture;
    ...
    private void updateScheduleGrid(String response) {
        ...
        for (String schedule : scheduleData) {
            ...
            if (details.length == 4) {
                ...
                int row = Lecture.times.indexOf(time) + 1;
                int col = Lecture.days.indexOf(day) + 1;
