                ...
                try {
                    ...
                    if (message.contains("ADD")) {
                        ...
                        if (!modules.contains(parts[1])) {
                            ...
                            if (moduleCount < 5) {
                                ...
                                if (schedule[lec.getLecTimeNum()][lec.getDayNum()] == null) {
                                    ...
                                    //response = "Error: Time slot taken. Cannot add this lecture to the schedule.";
                                    throw new IncorrectActionException("Time slot taken. Cannot add this lecture to the schedule.");
                                }

                            } else {
                                //response = "Error: Max 5 modules per course, cannot add another module.";
                            ...
                            if (schedule[lec.getLecTimeNum()][lec.getDayNum()] == null) {
                                ...
                                //if not free, send error message
                                //response = "Error: Time slot taken. Cannot not add this lecture to the schedule.";
                                throw new IncorrectActionException("Time slot taken. Cannot add this lecture to the schedule.");
                            }
                        }
                        ...
                        if (schedule[lec.getLecTimeNum()][lec.getDayNum()] != null &&
                            ...
                            //send message back
                            response = String.format("Success: Lecture removed successfully.\nTime: %s, Room: %s", lec.getLecTime(), lec.getRoomNum());
                        } else {
                            //if it doesn't exist, send error message
                            //response = "Error: This lecture does not exist. Cannot not remove from schedule.";
